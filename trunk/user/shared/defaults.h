...
#define DEF_WLAN_2G_SSID	BOARD_PID "_2.4"
#define DEF_WLAN_5G_SSID	BOARD_PID
#define DEF_WLAN_2G_GSSID	BOARD_PID "_GUEST_2.4"
#define DEF_WLAN_5G_GSSID	BOARD_PID "_GUEST"
